...
const Quality = () => {
    return (
        <div className='bg-white px-[60px] py-[60px]'>
            <h1 className='font-bold sm:text-7xl text-3xl text-[#039be6] uppercase mb-[40px]'>Our Quality</h1>
            <div className='flex flex-col gap-3'>
                ...
                <h1 className='font-semibold text-[#039be6] sm:text-2xl text-xl'>Our Quality team</h1>
                ...
                <div className='flex sm:flex-row flex-col gap-4 mt-[40px] mb-[20px]'>
                    <img src={quality} alt="QA" className='sm:w-[60%] h-[300px] rounded-full object-cover' />
                    <div className='flex flex-col gap-4 sm:w-[40%]'>
                        <h1 className='font-semibold text-[#039be6] sm:text-2xl text-xl'>Our Quality Standards</h1>
                        <p className='text-gray-500 sm:w-[70%]'>We  serve the customer with 100% organic Food Ingredients a reliable supply of high-quality products
                            which are fully suitable and safe for the end use intended by our customers, and meet all legal
                            requirements. </p>
                    </div>
                </div>
                <h1 className='font-semibold text-[#039be6] sm:text-2xl text-xl'>
                ...
                <div className='flex sm:flex-row flex-col gap-4 my-[40px]'>
                    <div className='sm:w-[50%] flex flex-col gap-2'>
                        <h1 className='font-semibold text-[#039be6] sm:text-2xl text-xl'>General Quality Statement</h1>
                    ...
                    <img src={qual} alt="quality image" className='sm:w-[50%] h-[300px] object-cover rounded-full' />
                </div>
                <h1 className='font-semibold text-[#039be6] sm:text-2xl text-xl'>General disclaimer</h1>
