    ...
    return (
        <div className='px-[40px] py-[60px] bg-white'>
            <div className='flex flex-col gap-3 mb-[40px]'>
                <h1 className='font-bold text-7xl text-[#039be6] uppercase'>Private Label</h1>
                <h1 className='font-bold text-lg'>Interested in developing your own brand with only organic ingredients?</h1>
            ...
            <div className='flex gap-6'>
                ...
                <div className='w-[50%]'>
                    <h1 className='font-bold text-2xl text-[#039be6] mb-[20px]'>What we offer</h1>
            ...
            <div className='grid grid-cols-2 gap-3 bg-[#039be6]/5 py-[60px] px-[20px]'>
                <div>
                    <h1 className='font-bold text-2xl text-[#039be6] mb-[20px]'>
                        In short
                    </h1>
                ...
                <div>
                    <h1 className='font-bold text-2xl text-[#039be6] mb-2'>
                        Packaging options
                    </h1>
            ...
            <div className='bg-white py-[40px]'>
                <h1 className='font-bold text-2xl text-[#039be6] mb-[40px]'>Why choose DO IT Organic for your private label?</h1>
